...
<div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Kelola_barang</h3>
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right"><form action="<?php echo site_url('kelola_barang/index'); ?>" class="form-inline" method="get" style="margin-top:10px">
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $kelola_barang->id;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
				...
				echo ' '; 
				echo anchor(site_url('kelola_barang/update/'.$kelola_barang->id),' <i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"'); 
				echo ' '; 
				echo anchor(site_url('kelola_barang/delete/'.$kelola_barang->id),' <i class="fa fa-trash"></i>','class="btn btn-xs btn-danger" onclick="javasciprt: return confirmdelete(\'kelola_barang/delete/'.$kelola_barang->id.'\')"  data-toggle="tooltip" title="Delete" '); 
				?>
			</td>
		</tr>
                <?php
